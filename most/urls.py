...
urlpatterns = [
    ...
    path('profile/collaborations/', collaborations, name='collaborations'),
    ...
    path('certification/create', create_certification, name='create_certification'),
    path('certification/<certification_id>/edit', edit_certification, name='edit_certification'),
    path('create/certification/<certification_id>/delete', delete_certification, name='delete_certification'),
